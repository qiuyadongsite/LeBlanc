 ...
 * @Auther: qiuyd
 * @Date: 2019/7/1 13:49
 * @Description:qiuyadong5241@qq.com
 */
...
/*        testLeetCode030();*/
    ...
    private static void testLeetCode036(){
        char[][] board={
  ...
  {'.','.','.','.','8','.','.','7','9'}}
;
        boolean validSudoku = new LeetCode036有效的数独.Solution().isValidSudoku(board);
    }
    private static void testLeetCode034() {
        String t="()(()";
      /*  int[] i = new LeetCode034在排序数组中查找元素的第一个和最后一个位置.Solution().searchRange(t);
        System.out.println(Arrays.toString(i));*/
    }

    private static void testLeetCode032() {
        //"()(()"
        int i = new LeetCode032最长有效括号.Solution().longestValidParentheses("()(()");
        System.out.println(i);
    }


    private static void testLeetCode031() {
       int[] nums=new int[]{1,3,2};
        new LeetCode031下一个排列.Solution().nextPermutation(nums);
